   ...
   public class Emploee_DAL
    {
        ...
        public bool Logn(Employee oEmployee)
        {
            con = new SqlConnection(scon);
            com = new SqlCommand("Logn", con);
            com.CommandType = CommandType.StoredProcedure;
            com.Parameters.AddWithValue("@pass", oEmployee.Password);
            com.Parameters.AddWithValue("@uname", oEmployee.UserName);

            SqlParameter OSqlParameter = new SqlParameter("@result", null);
            OSqlParameter.Direction = ParameterDirection.Output;
            OSqlParameter.SqlDbType = SqlDbType.Int;
            com.Parameters.Add(OSqlParameter);
